...
var playerMoveAction = function(playerMove){
 ...
      message2 = ('GAME OVER! YOU WON! Punkty które zdobyłeś:<br>' + playerScore);
      canPlay = false;
      displayGameResult('', message2);
    } else if (computerScore == winsNumber){
      message2 = ('GAME OVER! Twój przeciwnik zwyciężył! Punkty które zdobył:<br> ' + computerScore);
      canPlay = false;
      displayGameResult('', message2);
    } else {
      message2 = ('<strong>Round</strong> no ' + roundNumber + '<br>' + '<strong>Player1 result <br></strong>' + playerScore + '<br>' + '<strong>Player2 result</strong> <br>' + computerScore + '<br> Gramy do ' + winsNumber);
